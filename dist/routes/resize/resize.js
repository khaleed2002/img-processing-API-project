...
function resizeImg(source, width, height) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    thumbPath = win32_1.default.join(win32_1.default.dirname(win32_1.default.dirname(source)), 'img thumb', win32_1.default.parse(source).name + "_thumb_".concat(width, "_").concat(height, ".jpg"));
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
...
route.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var folderPath, width, height, imgPath, thumbPath, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                folderPath = win32_1.default.resolve();
                width = Number(req.query.width), height = Number(req.query.height);
                imgPath = win32_1.default.join(folderPath, 'src', 'imgs', "/".concat(req.query.filename, ".jpg"));
                //check if image name is valid
                if (!fileExist(imgPath)) {
                    return [2 /*return*/, res.send("<h1 style='color:red;font-weight:bold;'>Image you selected is not found,<h1><p>add it first to src/imgs folder</p>")];
                }
                ...
                thumbPath = win32_1.default.join(win32_1.default.dirname(win32_1.default.dirname(imgPath)), 'img thumb', win32_1.default.parse(imgPath).name + "_thumb_".concat(width, "_").concat(height, ".jpg"));
                if (!fileExist(thumbPath)) return [3 /*break*/, 1];
                return [2 /*return*/, res.sendFile(thumbPath)];
            case 1:
                console.log('new image created in thumb folder: ', win32_1.default.parse(imgPath).name + "_thumb_".concat(width, "_").concat(height, ".jpg"));
                _b = (_a = res).sendFile;
